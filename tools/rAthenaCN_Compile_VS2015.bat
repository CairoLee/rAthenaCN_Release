...
rem 编译复兴后的正式版
set CL=
Devenv ..\rAthena-14.sln /clean
Devenv ..\rAthena-14.sln /Rebuild "Release|Win32"

move /Y ..\login-server.exe ..\login-server-re.exe
move /Y ..\login-server.pdb ..\login-server-re.pdb
move /Y ..\char-server.exe ..\char-server-re.exe
move /Y ..\char-server.pdb ..\char-server-re.pdb
move /Y ..\map-server.exe ..\map-server-re.exe
move /Y ..\map-server.pdb ..\map-server-re.pdb

del /q "..\login-server-pre.exe"
del /q "..\login-server-pre.pdb"
del /q "..\char-server-pre.exe"
del /q "..\char-server-pre.pdb"
del /q "..\map-server-pre.exe"
del /q "..\map-server-pre.pdb"
...
move /Y ..\login-server.exe ..\login-server-pre.exe
move /Y ..\login-server.pdb ..\login-server-pre.pdb
move /Y ..\char-server.exe ..\char-server-pre.exe
move /Y ..\char-server.pdb ..\char-server-pre.pdb
move /Y ..\map-server.exe ..\map-server-pre.exe
move /Y ..\map-server.pdb ..\map-server-pre.pdb

move /Y ..\login-server-re.exe ..\login-server.exe
move /Y ..\login-server-re.pdb ..\login-server.pdb
move /Y ..\char-server-re.exe ..\char-server.exe
move /Y ..\char-server-re.pdb ..\char-server.pdb
move /Y ..\map-server-re.exe ..\map-server.exe
move /Y ..\map-server-re.pdb ..\map-server.pdb
